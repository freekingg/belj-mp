<template>
	<view class="index">
		...
		<!-- 右上角形式的tabbar按钮-->
		<!-- <view class="">
      <view class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur button-1" @tap.stop="changeTabbar(0)">
        <view class="tn-icon-home-love-fill" :class="[currentTabbarIndex === 0 ? 'tn-color-blue' : 'tn-color-white']"></view>
      </view>
      <view class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur button-2"  @tap.stop="changeTabbar(4)">
        <view class="tn-icon-ghost-fill" :class="[currentTabbarIndex === 4 ? 'tn-color-blue' : 'tn-color-white']"></view>
      </view>
    </view>  -->
        ...
        <view class="nav-index-button">
          <view class="nav-index-button__content">
              <view class="nav-index-button__content--icon tn-flex tn-flex-row-center tn-flex-col-center">
                <view class="bar-circle">
                  <image class="" src='https://cdn.nlark.com/yuque/0/2021/png/280373/1634526816906-assets/web-upload/568740d8-8669-48d5-9b3e-b510e39d127d.png'></image>
                </view>
              </view>  
          </view>
          ...
          <view class="nav-index-button__meteor">
			...
			<view class="action" @tap.stop="changeTabbar(3)">
				...
				<view class="" :class="[currentTabbarIndex === 3 ? 'tn-color-blue' : 'tn-color-gray']">名片</view>
			</view>
...
<script>
	...
	export default {
		...
		onShareAppMessage(e) {
			let shareobj = {
				title: '问卷项目', //分享的标题
				path: '/pages/index/index?shareId=', //好友点击分享之后跳转的页面
				desc:'问卷项目问卷项目问卷项目',

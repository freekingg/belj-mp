<template>
  <view class="page-c">
      ...
      <view class="tn-strip-bottom">
        ...
        <view class='tn-margin tn-padding-top-sm'>
          <view class="tn-text-bold">
            <text class='tn-text-xxl tn-padding-right'>徐猪猪</text>
            <text class='tn-text-lg tn-color-gray'>高级UI设计</text>
          </view>
    ...
    <view class="">
      <view class="icon15__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-shadow-blur button-1" @click="tn('/pageA/create/create')">

...
<!-- 顶部自定义导航 -->
    <tn-nav-bar fixed customBack :bottomShadow="false" :backgroundColor="navBarBackgroundColor" id="navbar">
      ...
      <view class="tn-flex tn-flex-col-center tn-flex-row-center" :style="[navBarStyle2]">
        <view class="tn-text-bold tn-text-xl">你的名字</view>
      </view>
    </tn-nav-bar>
          ...
          <view class="tn-flex tn-flex-col-center">
            <view class="tn-color-white">
              ...
              <view class="tn-text-ellipsis tn-text-sm">
                ...
                <!-- <text class="tn-icon-edit tn-padding-xs"></text> -->
              </view>
            </view>
          </view>
        </view>
    ...
    <view class="group-wrap tn-bg-white" id="page_tips">
      ...
      <view class="tn-flex tn-flex-row-between" style="padding: 60rpx 0 30rpx 0;">
        <view class="tn-flex-1 justify-content-item tn-text-center tn-margin-xs">
          <tn-button backgroundColor="#fbbd12" padding="40rpx 0" width="90%" :fontSize="28"  @click="tn('')">
            <text class="tn-color-white">关注博主</text>
            <text class="tn-icon-add-square tn-padding-left-xs tn-color-white"></text>
          </tn-button>
        </view>
        <view class="tn-flex-1 justify-content-item tn-text-center tn-margin-xs">
        ...
        data: [
          {
            title: '看月亮爬上来',
            userName: '试试就逝世',
            mainImage: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1676024066753-assets/web-upload/ac0c3f78-5c36-4e5c-a406-941210274dc4.jpeg',
          ...
          },
          {
            title: '万科神奇动物主场',
            userName: '你的名字',
            mainImage: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1676024253288-assets/web-upload/2c79d4c5-3ced-490a-b121-9eaf509d5df8.jpeg',
          ...
          },
          {
            title: '北海世博园灯笼走廊',
            userName: '青梅煮马',
            mainImage: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1676024338241-assets/web-upload/cf977132-e57a-4dbc-af79-6feb410b8ac7.jpeg',
          ...
          },
          {
            title: '浦江航拍夜上海',
            userName: '你的名字',
            mainImage: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1676024253310-assets/web-upload/829f2ae6-823c-48e7-b6a5-5825ab127af2.jpeg',
          ...
          },
          {
            title: '疫情也阻挡不了滑滑板',
            userName: '凶一下试试',
            mainImage: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1676024253264-assets/web-upload/c95816dc-59d9-4f05-a2be-774989dc711b.jpeg',
            userImage: 'https://resource.tuniaokj.com/images/blogger/avatar_2.jpeg',
            tags: [],
            viewUser: {
              latestUserAvatar: [
          ...
          },
          {
            title: '疫情也阻挡不了滑滑板',
            userName: '凶一下试试',
            mainImage: 'https://cdn.nlark.com/yuque/0/2023/jpeg/280373/1676024267194-assets/web-upload/910175c6-b017-413d-bded-45257a94504a.jpeg',
            userImage: 'https://resource.tuniaokj.com/images/blogger/avatar_3.jpeg',
            tags: [],
            viewUser: {
              latestUserAvatar: [
